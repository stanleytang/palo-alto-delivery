    ...
    html += '<div class="span3">' +
      '<div class="media">' +
        '<a class="pull-left" target="_blank" href="' + menuLink + '">' +
          '<img class="media-object img-rounded restaurants-list-image" src="' + imageLink + '">' + 
        '</a>' +
        '<div class="media-body">' +
          '<p class="media-heading restaurants-list-name">' + restaurant.name + '</p>' +
